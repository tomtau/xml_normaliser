...
/**
 * Unit tests of the basic DTD parser with a provided root node
 * 
 * @author Tomas Tauber
 * 
 */
public class DTDParserTestCoursesExternal {
	...
	public static void setUpBeforeClass() throws Exception {
		parsed = DTDParser.parse(Utils.readFile(TEST_FILE), "courses");
	}
